...
<tr><td>Architectures — <b>swept, all of them</b></td><td><b>270 of 297 forward</b> (91%), up from 215 of 297 (72%) in ARCH100. <b>The denominator is not 528.</b> 528 is every model type <code>AutoModel</code> can build; of those, <b>231 fail on upstream torch too</b> under the same shrunk random-weight config, so they are not this project's gap and are excluded — <i>270 of 528</i> would be a different and wrong claim. The remaining <b>27</b> are blocked here and need <b>16 distinct operator names</b>, which is a <i>first-wall</i> count: closing one wall can reveal another. And <b>a forward is not a match</b> — this row measures reachability, the row above measures agreement, and only 26 architectures have been checked for agreement (<a href="docs/ARCH200.md">ARCH200.md</a>, prior round <a href="docs/ARCH100.md">ARCH100.md</a>)</td></tr>
<!-- DOCWATCH: symbol-in-file docs/ARCH200.md 270 present -->
<!-- DOCWATCH: symbol-in-file docs/ARCH200.md 297 present -->
<!-- DOCWATCH: symbol-in-file docs/ARCH200.md 27 present -->
<!-- DOCWATCH: symbol-in-file docs/ARCH200.md 16 present -->
...
- **27 of 297 architectures do not forward**, needing 16 operator names, down from 82/31 in
  ARCH100. See the Status table for what 297 means.
...
`0.0.12a0` ships five platform wheels, all `cp313-abi3` — one binary per platform, loadable by
...
> import. Ask for `0.0.12a0` or later.
>
