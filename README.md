...
<tr><td>Architectures — <b>swept, all of them</b></td><td><b>290 of 297 forward</b> (98%), up from 270/297 (91%) in ARCH200 and 215/297 (72%) in ARCH100. <b>The denominator is not 528.</b> 528 is every model type <code>AutoModel</code> can build; of those, <b>231 fail on upstream torch too</b> under the same shrunk random-weight config, so they are not this project's gap and are excluded — <i>290 of 528</i> would be a different and wrong claim. The remaining <b>7</b> are blocked here, three of them sharing one argument-form gap (a tensor/tuple passed where the shim's table has no matching row), which is a <i>first-wall</i> count: closing one wall can reveal another. And <b>a forward is not a match</b> — this row measures reachability, the row above measures agreement, and numerical agreement beyond the 26 already checked is being measured by a separate, concurrent round, not restated here (<a href="docs/ARCH300.md">ARCH300.md</a>, prior rounds <a href="docs/ARCH200.md">ARCH200.md</a>, <a href="docs/ARCH100.md">ARCH100.md</a>)</td></tr>
...
- **7 of 297 architectures do not forward**, down from 27/16 in ARCH200 and 82/31 in ARCH100.
  See the Status table for what 297 means.
