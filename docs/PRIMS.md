...
docs/DECOMP.md §12.4 가 "NNAPI 를 막는 것은 분해 24 개가 아니라 `prims.*` 13 개" 라고 셌습니다.
...
## 6. `rwkv` — docs/DEMAND8.md 의 다섯 번째 모델이 닫혔습니다

docs/DEMAND8.md §2.6 이 남긴 하나입니다. `TensorBase.new_empty` 뒤에 벽이 **하나 더** 있었고,
