...
`docs/COLLECT2.md` §7 measured this backend's async surface against upstream
...
The topology is unchanged (`docs/FEDERATED4.md` §1): a star, hub at rank 0,
...
the shape of `docs/COLLECT2.md` §4's `reduce` decision. It is written down
...
tolerance is `docs/AGREE.md` §2's method, read off upstream's own
