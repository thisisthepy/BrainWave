# METAFAM — closing the two families docs/VOICE4.md left open
...
process with `PYTHONPATH` stripped -- the same method docs/VOICE4.md §6 and docs/AGREE.md
§2 use.
...
docs/META.md §7.4 groups the 80 (now 68) ops with a dense kernel but no meta kernel into
...
**Forward pass under meta** (docs/META.md §7.4 says this "여전히 안 됩니다" going in, and it
