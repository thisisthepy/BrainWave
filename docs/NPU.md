...
## 4. `_SIGNATURES`: where docs/DECOMP.md §12.2's caveat becomes an obstacle
...
docs/DECOMP.md §12.6 recorded the CoreML operator set as **not measured** and
...
Against the models docs/DECOMP.md §12.3 measured, after folding:
