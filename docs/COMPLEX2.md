...
`docs/COMPLEX.md` is the sizing document and it is the specification for this
...
the dtype or the operator, and `docs/COMPLEX.md` §4 established that naming the
...
`docs/COMPLEX.md` §4 called the existing refusal "the thing to protect", and it
...
`docs/COMPLEX.md` §1 reported the tag half as "already done… with correct
...
neighbour in `docs/ARCH100.md` and is real-valued — nothing to do with complex).

---

## 9. What this round changed

Split as `docs/ARCH100.md` §5.3 asks:
